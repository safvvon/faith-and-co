    ...
    <div className="w-full min-h-screen bg-[#090a14] text-[#FFFFFF] font-dm selection:bg-[#C9A84C] selection:text-[#090a14] relative overflow-x-hidden pt-24 sm:pt-28">
      ...
      <header className="relative w-full py-20 sm:py-28 px-6 sm:px-12 text-center border-b border-[rgba(255,255,255,0.07)] overflow-hidden">
        <div className="max-w-3xl mx-auto relative z-10 space-y-6 animate-fade-up">
          ...
          {/* Large Headline */}
          <h1 className="font-cormorant font-light text-4xl sm:text-6xl md:text-7xl text-white tracking-tight leading-[1.08]">
            Let's talk about <span className="italic text-[#C9A84C] font-normal">your property</span>
          </h1>

          {/* Supporting Text */}
          <p className="font-dm text-base sm:text-lg font-light text-white/70 leading-relaxed max-w-2xl mx-auto">
      ...
      {/* ----------------------------------------------------
          5. MAIN CONTACT SECTION (2-COL LAYOUT)
      ---------------------------------------------------- */}
      <main className="w-full max-w-[1200px] mx-auto px-6 sm:px-12 py-16 sm:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 animate-fade-up">
            <div className="space-y-3">
              ...
              <p className="font-dm text-sm text-white/65 font-light leading-relaxed">
            ...
            <div className="space-y-4 font-dm border-t border-[rgba(255,255,255,0.07)] pt-4">
              ...
              {/* Phone */}
              <div className="py-4 border-b border-[rgba(255,255,255,0.04)] flex items-start gap-4">
                <div className="w-9 h-9 border border-[#C9A84C]/40 bg-[#C9A84C]/5 flex items-center justify-center text-[#C9A84C] flex-shrink-0 mt-0.5">
                  <Phone className="w-4 h-4" />
                </div>
                <div>
                  <span className="text-[10px] font-semibold tracking-[0.2em] uppercase text-white/50 block mb-0.5">PHONE</span>
                  <a href="tel:02085741700" className="text-sm font-medium text-white hover:text-[#C9A84C] transition-colors block">
                    020 8574 1700
                  </a>
                  <span className="text-xs text-white/50 font-light block mt-0.5">Mon–Fri, 9:00 – 18:30</span>
                </div>
              </div>
              ...
              <div className="py-4 border-b border-[rgba(255,255,255,0.04)] flex items-start gap-4">
                ...
                <div>
                  <span className="text-[10px] font-semibold tracking-[0.2em] uppercase text-white/50 block mb-0.5">EMAIL</span>
                  <a href="mailto:info@faithandco.co.uk" className="text-sm font-medium text-white hover:text-[#C9A84C] transition-colors block">
                    info@faithandco.co.uk
                  </a>
                  <span className="text-xs text-white/50 font-light block mt-0.5">We aim to reply within one working day</span>
                </div>
              </div>
              ...
              <div className="py-4 border-b border-[rgba(255,255,255,0.04)] flex items-start gap-4">
                ...
                <div>
                  <span className="text-[10px] font-semibold tracking-[0.2em] uppercase text-white/50 block mb-0.5">WHATSAPP</span>
                  <a href="https://wa.me/442085741700" target="_blank" rel="noopener noreferrer" className="text-sm font-medium text-white hover:text-[#C9A84C] transition-colors block">
                    Message us on WhatsApp
                  </a>
                  <span className="text-xs text-white/50 font-light block mt-0.5">Quick questions answered fast</span>
                </div>
              </div>
              ...
              <div className="py-4 flex items-start gap-4">
                ...
                <div>
                  <span className="text-[10px] font-semibold tracking-[0.2em] uppercase text-white/50 block mb-0.5">AREA COVERED</span>
                  <span className="text-sm font-medium text-white block">All 32 London Boroughs</span>
                  <span className="text-xs text-white/50 font-light block mt-0.5">Greater London &amp; the Home Counties</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    } px-4 py-3.5 text-sm text-white font-dm placeholder-white/20 focus:outline-none focus:border-[#C9A84C] transition-colors rounded-none resize-none`}
                  />
                  {errors.message && (
                    <p className="text-rose-400 font-dm text-xs mt-1.5">{errors.message}</p>
                  )}
                </div>
